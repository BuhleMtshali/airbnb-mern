      ...
      <div className="relative">
        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg border rounded-xl z-10">
            {user ? (
              <>
                <Link to="/account/reservations" className="block px-4 py-2 hover:bg-gray-100">Reservations</Link>
                <button
                  onClick={logout}
              ...
              <>
                ...
                <Link to="/register" className="block px-4 py-2 hover:bg-gray-100">Become a host</Link>
              </>
            )}
          </div>
        )}
