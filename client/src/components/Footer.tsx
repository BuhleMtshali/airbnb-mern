...
export const Footer = () => {
  const footerLinks = [{
    section: 'Support',
    links: ['Help Center', 'AirCover', 'Supporting people with disabilities', 'Cancellation options', 'Our COVID-19 Response', 'Report a neighborhood concern']
  }, {
    section: 'Community',
    links: ['Airbnb.org: disaster relief housing', 'Combating discrimination', 'Celebrate diversity']
  }, {
    section: 'Hosting',
    links: ['Airbnb your home', 'AirCover for Hosts', 'Explore hosting resources', 'Visit our community forum', 'How to host responsibly', 'Airbnb-friendly apartments']
  }, {
    section: 'Airbnb',
        ...
        <div className="border-t border-gray-200 py-6">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            <div className="flex flex-col md:flex-row items-center mb-4 md:mb-0">
              <div className="text-sm text-gray-600">© 2023 Airbnb, Inc.</div>
